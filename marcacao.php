...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <form class="center_absolute display_grid" action="marcacao.php" method="post">
    ...
    <input class="w_25_rem margin_bottom_1_rem" type="text" name="assunto" placeholder="Assunto" autocomplete="off" required>
    <textarea name="mensagem" class="w_25_rem margin_bottom_1_rem" placeholder="Mensagem" required></textarea>
